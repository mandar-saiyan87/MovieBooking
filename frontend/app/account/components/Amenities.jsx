    ...
    <>
      <div className='my-2.5 max-w-max gap-3 grid grid-cols-2 md:grid-cols-3'>
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='WiFi' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='Swimming Pool' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='Kitchen' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='Free Parking' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='Air Condition' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='Pets Allowed' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='Elevator' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-5 border-[1px] cursor-pointer rounded-lg'>
          <input type="checkbox" value='TV' onChange={handleSelect}/>
