...
const Amenities = ({ amenities, setAmenities }) => {
  ...
  return (
    <>
      <div className='my-2.5 max-w-max gap-3 grid grid-cols-2 text-sm md:grid-cols-3 md:text-base'>
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('WiFi')} value='WiFi' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('Swimming Pool')} value='Swimming Pool' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('Kitchen')} value='Kitchen' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('Free Parking')} value='Free Parking' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('Air Condition')} value='Air Condition' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('Pets Allowed')} value='Pets Allowed' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('Elevator')} value='Elevator' onChange={handleSelect}/>
        ...
        <label className='flex items-center gap-2 p-3 border-[1px] cursor-pointer rounded-lg md:p-5'>
          <input type="checkbox" checked={amenities.includes('TV')} value='TV' onChange={handleSelect}/>
