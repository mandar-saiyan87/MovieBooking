      ...
      <div className='h-auto max-w-[1920px] bg-white m-auto'>
        <div className='max-w-[1536px] h-full m-auto py-10 px-4 md:p-10'>
          ...
          <div className='flex items-center gap-3 mt-10 overflow-auto no-scrollbar sm:justify-center md:gap-10'>
            <Link href='/account/profile' className={tab === '/account/profile' ? 'btnfunc flex gap-1' : 'flex gap-1 items-center font-medium text-primary text-sm py-1 px-3 rounded-full border-[1px] border-slate-400 md:py-2 md:px-4 md:text-base'}>
            ...
            <Link href='/account/bookings' className={tab === '/account/bookings' ? 'btnfunc flex gap-1' : 'flex gap-1 items-center font-medium text-primary text-sm py-1 px-3 rounded-full border-[1px] border-slate-400 md:py-2 md:px-4 md:text-base'}>
            ...
            <Link href='/account/accomodations' className={tab === '/account/accomodations' ? 'btnfunc flex gap-1' : 'flex gap-1 items-center font-medium text-primary text-sm py-1 px-3 rounded-full border-[1px] border-slate-400 md:py-2 md:px-4 md:text-base'}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-[18px] h-[18px] md:w-[22px] md:h-[22px]">
